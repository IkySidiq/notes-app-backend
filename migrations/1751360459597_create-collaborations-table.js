...
exports.up = (pgm) => {
  ...
  */
  pgm.addConstraint('collaborations', 'unique_note_id_and_user_id', 'UNIQUE(note_id, user_id)'); // TODO: Unique disini adalah multikolom. Penggunaannya untuk mencegah kombinasi data yang sama pada antar kolom
